...
export async function GET() {
  ...
  const friendships = await prisma.friendship.findMany({
    ...
    include: {
      sender: { select: { id: true, username: true, displayName: true, xpTotal: true, currentStreak: true } },
      receiver: { select: { id: true, username: true, displayName: true, xpTotal: true, currentStreak: true } },
    },
